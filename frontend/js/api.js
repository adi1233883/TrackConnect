...
function initSidebar(activePage) {
  ...
  if (avatarEl) {
    if (user.profile_image) {
      avatarEl.innerHTML = `<img src="http://const API_BASE = "https://3467-2401-4900-88eb-16c-4165-d666-48c3-2a2b.https://trackconnect.onrender.com-free.app/api"; "https://himself-finder-pace-placed.trycloudflare.com/api";"https://willow-sets-valium-subsequently.trycloudflare.com/api";${user.profile_image}" alt="${user.name}">`;
    } else {
